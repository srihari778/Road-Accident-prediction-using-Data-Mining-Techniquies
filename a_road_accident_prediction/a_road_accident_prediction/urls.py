...
urlpatterns = [
    ...
    url(r'^Predict_Road_Accident_Status/$', remoteuser.Predict_Road_Accident_Status, name="Predict_Road_Accident_Status"),
    ...
    url(r'^Find_Road_Accident_Prediction_Type_Ratio/$', serviceprovider.Find_Road_Accident_Prediction_Type_Ratio,name="Find_Road_Accident_Prediction_Type_Ratio"),
    ...
    url(r'^View_All_Road_Accident_Prediction/$', serviceprovider.View_All_Road_Accident_Prediction, name="View_All_Road_Accident_Prediction"),
